...
<fb:login-button scope="email,user_about_me,user_birthday,user_education_history,user_location,user_work_history,user_photos,friends_about_me,friends_birthday,friends_education_history,friends_location,friends_work_history,publish_stream" onlogin="checkLoginState();">
</fb:login-button>
